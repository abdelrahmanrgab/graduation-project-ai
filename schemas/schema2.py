...
def schema_2(user_text):
    return {
        "templateInfo": {
            "id": 2,
            "title": generate_text(f"Generate just only one a name for a website in just 2 words about {user_text}"),
        ...
        "hero": {
            "title": generate_text(f"Generate just only one a title for this website in just 5 words about {user_text}"),
            "subtitle": generate_text(f"Generate just only one a subtitle for this website in just 5 words about {user_text}"),
            ...
            "heros": [
                {
                    ...
                    "title": generate_text(f"Generate just only one a title name for a card related to {user_text}"),
                    "description": generate_text(f"Create just only one a brief description in 15 words for a card related to {user_text}")
                },
                {
        ...
        "testimonials": {
            ...
            "subtitle": generate_text(f"Generate just only one a subtitle in 5 words for testimonials related to {user_text}"),
            "testimonials": [
                {
                    "imgUrl": search_image("Portrait of a client"),
                    "name": generate_text(f"Generate just only one a name in 2 words"),
                    "opinion": generate_text(f"Generate just only one a brief description in 10 to 15 words for a client who used our services about {user_text}")
                },
                {
                    "imgUrl": search_image("Portrait of a client"),
                    "name": generate_text(f"Generate just only one a name in 2 words"),
            ...
            "projects": [
                {
                    ...
                    "title": generate_text(f"Generate just only one a title name for a project related to {user_text}"),
        ...
        "contact": {
            "title": generate_text(f"Generate just only one a title in 5 words for contact section related to {user_text}"),
            "description": generate_text(f"Generate just only one a subtitle in 10 words for contact section related to {user_text}"),
            "contacts": [
                {
                    "type": "email",
                    "title": generate_text(f"Generate just only one a subtitle in 5 words for email contact related to {user_text}"),
                ...
                {
                    "type": "facebook",
                    "title": generate_text(f"Generate just only one a subtitle in 5 words for Messenger contact related to {user_text}"),
                    "email": "mailto:ahmed.solimanth57@gmail.com",
                    "buttonText": "Connect",
                ...
                {
                    "type": "whatsapp",
                    "title": generate_text(f"Generate just only one a subtitle in 5 words for WhatsApp contact related to {user_text}"),
                    "email": "mailto:ahmed.solimanth57@gmail.com",
                    "buttonText": "Connect",
