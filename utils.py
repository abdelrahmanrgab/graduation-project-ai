...
# Function to get the Google Custom Search URL with the provided API key
...
# Function to search for an image with API key management
def search_image(image_name):
    # return "null"
    random.shuffle(api_keys)  # Shuffle the API keys to randomize their use
